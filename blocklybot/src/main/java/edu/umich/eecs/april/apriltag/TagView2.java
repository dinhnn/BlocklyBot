 ...
 */
public class TagView2 extends GLSurfaceView implements Camera.PreviewCallback {
    ...
    class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            int rotation = ((WindowManager)TagView2.this.getContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getRotation();
    ...
    static class ProcessingThread extends Thread {
        ...
        public void run() {
            ...
            float[] coordinates = new float[parent.mDetections.size()*4];
            int i = 0;
            for(ApriltagDetection d:parent.mDetections){
            ...
            if(ApriltagNative.homography_project(coordinates)){
                ...
                for(ApriltagDetection d:parent.mDetections){
                    ...
                    i++;
                    if(d.id>=0){
                        final Activity a = (Activity )parent.getContext();
